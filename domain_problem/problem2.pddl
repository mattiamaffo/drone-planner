;; PROBLEM 2: Drone mission with energy consumption (initial value = 5) and data collection from sensors (temperature and humidity), without blocked areas.
;; The goal: collecting data from areas 1, 2, and 7 by minimizing energy consumption.

;; PLANNER USED:
;; HEURISTICS USED:

(define (problem drone_mission_2)
  (:domain drone_mission_energy)
  ...
  (:init
    ...
    (= (EnergyLevel drone1) 5)
    (= (EnergyLevel drone2) 5)
  ...
  ;; Metric to minimize energy consumption
